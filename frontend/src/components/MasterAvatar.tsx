...
export function MasterAvatar({ master, className }: MasterAvatarProps) {
  ...
  return (
    <span className={classNames} style={{ backgroundColor: getMasterColor(master.id) }} aria-hidden="true">
